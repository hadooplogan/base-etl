 ...
 * @author haoxing
 */
public class AddTimeNode {
    public static Dataset getAddTimeNode(SparkSession spark,String datadate){

        String hql = "select a.*,\n" +
                "nvl(b.eb0091,0) as eb0091,\n" +
                "nvl(b.ee0023,0) as ee0023,\n" +
                ...
                "cast ("+datadate+"as String) as timestamp"+
        ...
        return DataFrameUtil.getDataFrame(spark,hql,"tmptimenode");
    }
}
