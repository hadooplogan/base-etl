...
public abstract class AbstractConvert implements IConvert {
    ...
    final IDataAdapter<Dataset,SparkSession,String>  adapterText = new HdfsDataAdapterImpl();

    final IDataAdapter<Dataset,SparkSession,Map<String,String>>  adapterES = new EsDataAdapterImpl();
